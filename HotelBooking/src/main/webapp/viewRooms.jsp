                                ...
                                <nav>
                                    <ul id="navigation">
                                      <li><a  href="viewFeedback.jsp">FeedBacks</a></li>
                                        ...
                                        <li><a class="active" href="viewRooms.jsp">Delete Room</a></li>
...
<%
Connection con=ConnectionPro.createconnection();
String query=" SELECT `room_id`, `room_type`, `room_number`, `room_description`,`price` FROM `rooms` ";
...
<td><%= room_price  %></td>
<td><a href="viewRooms.jsp?room_id=<%= room_id %>">Delete</a>
