...
<body>
    ...
    <!-- header-end -->
<% UserModel n=(UserModel)request.getAttribute("usermodel");
...
<%}  %>
 ...
 <form action="checkAvailability" method="post">
                                ...
                                <div class="row">
                                    <div class="col-xl-6">
                                        <input type="date"   id="datepicker"  placeholder="Check in date" name="in">
                                    </div>
                                    <div class="col-xl-6">
                                        <input type="date" required pattern="\d{4}-\d{2}-\d{2}" id="datepicker2" placeholder="Check out date" name="out">
                                    </div>
                                    <div class="col-xl-12">
                                        <select class="form-select wide" id="default-select" class="" name="type">
                                            <option data-display="Room type">Room type</option>
                                            <option value="Luxury">Laxaries Rooms</option>
