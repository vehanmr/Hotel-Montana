                                ...
                                <nav>
                                    <ul id="navigation">
                                       ...
                                       <li><a  href="addRoom.jsp">Add Room</a></li>
                                        ...
                                        <li><a class="active" href="deleteUser.jsp">Delete Users</a></li>
                                    </ul>
                                </nav>
                            </div>
                        </div>
...
<%Connection con=ConnectionPro.createconnection();
String query="SELECT `user_id`, `full_name`, `email`, `contact_no`, `gender` FROM `users` WHERE `category`='User' ";
...
<td><%= contact_no  %></td>
<td><%= gender  %></td>
<td><a href="deleteUser.jsp?user_id=<%= user_id%>">Delete</a>
